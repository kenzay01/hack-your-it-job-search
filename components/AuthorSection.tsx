...
const AuthorSection = () => {
  return (
    <section className="py-12 bg-gradient-to-tr from-blue-600 to-blue-800 relative overflow-hidden">
      {/* Білий паралелограм */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 ">
          ...
          <div className="flex justify-center items-center hover:scale-105 transition-transform duration-300">
            <div className="relative mt-10">
              ...
              <div className="absolute -bottom-4 -left-4 w-12 h-12 bg-blue-300 rounded-full opacity-40"></div>
            </div>
          </div>
          ...
          <div className="space-y-6 pt-24">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500 mt-4 hover:scale-102 transition-transform duration-300">
