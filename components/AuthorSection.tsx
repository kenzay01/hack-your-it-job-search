...
const AUTHOR_DATA = [
  ...
  },
  {
    ...
    text: (
      <>
        Я такий самий IT-шник як і ти. <br /> Постійно{" "}
        <span className="underline">ходжу</span> на співбесіди і шукаю
        максимально ефективний шлях, для того, щоб качати свою експертизу і
        знаходити класні офери. <br /> Я вірю не в обман компаній і рекрутерів,
        а у win-win взаємостосунки.
      </>
    ),
  },
  {
