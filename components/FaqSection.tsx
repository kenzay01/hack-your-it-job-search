...
const FaqSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Так. Марафон закриває частину упаковки себе як спеціаліста: CV, LinkedIn, та пошуку роботи. Але ми не навчимо тебе програмувати «з нуля».  Тобі потрібні навички програмування у твоєму напрямку. Усе інше – як продавати себе й проходити співбесіди – отримаєш на марафоні.",
    },
    {
      number: "3",
      question: "Гарантія повернення коштів: як це працює?",
      answer:
        "7 днів від старту. Напиши у Telegram-підтримку «Хочу повернення» – протягом 24 год повертаємо 100%, якщо відчуваєш, що марафон не дає результату",
    },
    {
      number: "4",
      question:
      ...
      answer:
        "Ми розглядаємо пошук роботи в Україні та ЄС + мій досвід з прямими контрактами з США. Додатково ми піднімемо тему оподаткування на B2B контрактах у різних країнах.",
    },
    {
      number: "5",
