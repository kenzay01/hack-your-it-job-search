...
export const metadata: Metadata = {
  ...
  description:
    "Як хакнути пошук роботи в ІТ. Ефективний марафон з пошуку роботи в IT сфері. Отримай офер за 14 днів завдяки перевіреній стратегії, практичним завданням та підтримці ментора.",
  keywords:
  ...
  openGraph: {
    title: "Марафон «Хакни пошук роботи в IT за 14 днів»",
    description:
      "Марафон з пошуку роботи в IT, який допоможе тобі отримати офер за 14 днів. Перевірена стратегія для всіх IT спеціальностей.",
  ...
  twitter: {
    ...
    title: "Марафон «Хакни пошук роботи в IT за 14 днів»",
    description:
      "Ефективний марафон з пошуку роботи в IT. Отримай офер за 14 днів завдяки перевіреній стратегії та підтримці ментора.",
